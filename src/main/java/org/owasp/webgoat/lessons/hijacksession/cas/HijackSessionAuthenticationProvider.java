...
public class HijackSessionAuthenticationProvider implements AuthenticationProvider<Authentication> {
  ...
  // session ids must come from a CSPRNG: a sequential counter (or anything else guessable)
  // lets an attacker predict/brute-force another user's valid session id
